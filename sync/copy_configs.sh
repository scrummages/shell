...
&& cp -avp ~/.config/alacritty/alacritty.toml ~/Media/Configs/config/alacritty/alacritty.toml \
&& cp -avp ~/.config/ranger/rc.conf ~/Media/Configs/config/ranger/rc.conf \
&& cp -avp ~/.config/picom.conf ~/Media/Configs/config/picom.conf \
&& cp -avp /etc/pacman.conf ~/Media/Configs/pacman.conf \
